...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-md border border-input bg-background/40 px-3.5 py-2 text-sm",
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <CaretDownIcon weight="bold" className="size-4 opacity-60" />
